$ENEMIES = [
  ...
  [
    ...
    { id: 3, name: 'スカル', hp: 50, atk: 120, base_atk: 15, def: 80, base_def: 10, sp: 100, exp: 5, actions: [1, 2, 4] },
  ],
  # Rank 2
  [
  ...
  # Rank 6 (赤ずきんボス)
  [
    { id: 14, name: '邪悪な狼', hp: 200, atk: 100, base_atk: 30, def: 110, base_def: 10, sp: 20, exp: 5, actions: [1, 2, 3] },
  ],
  # Rank 7 (ジャックと豆の木ボス)
  [
    { id: 15, name: '破壊の巨人', hp: 200, atk: 100, base_atk: 30, def: 110, base_def: 10, sp: 100, exp: 5, actions: [1, 2, 3] },
  ],
  # Rank 8 (長靴を履いた猫ボス)
  [
    { id: 16, name: '堕ちた国王', hp: 200, atk: 100, base_atk: 30, def: 110, base_def: 10, sp: 50, exp: 5, actions: [1, 2, 3] },
  ],
  # Rank 9 (シンデレラボス)
  [
    { id: 17, name: '恐怖の継母', hp: 200, atk: 100, base_atk: 30, def: 110, base_def: 10, sp: 60, exp: 5, actions: [1, 2, 3] },
  ],
]
